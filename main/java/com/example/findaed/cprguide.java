    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aedfind_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(cprguide.this, AEDActivity.class);
        ...
        chestcompressionsguide_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cprguide.this, chestcompressionsguide.class);
                startActivity(intent);
            }
        });
        ...
        cprguide_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(cprguide.this, cprguide.class);
                startActivity(intent);
            }
        });
