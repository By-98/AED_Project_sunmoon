...
public class AEDActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aedactivity);
        ...
        aedfind_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AEDActivity.this, AEDActivity.class);
        ...
        chestcompressionsguide_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AEDActivity.this, chestcompressionsguide.class);
                startActivity(intent);
            }
        });
        ...
        cprguide_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AEDActivity.this, cprguide.class);
                startActivity(intent);
            }
        });
    }
